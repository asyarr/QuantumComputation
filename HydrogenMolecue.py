...
plt.scatter(bond_lengths, energy, marker = "o", label = "Este trabalho")
...
plt.xlabel('Diferentes comprimentos de ligação (Å)')
plt.ylabel('Energia dos estados fundamentais [Hartree]')
plt.title('Energia dos estados fundamentais da molécula de hidrogênio \n em diferentes comprimentos de ligação')
plt.legend()
